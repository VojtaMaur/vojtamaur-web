...
7. Obraz není dokonale čistý, ale obsahuje slabý vizuální šum. Ten vzniká kombinací fyzikálního šumu světla, vlastního šumu fotoreceptorů a další nervové aktivity zrakového systému. Za běžných podmínek ho mozek většinou potlačuje, ale může být patrný hlavně ve tmě, při zavřených očích nebo na jednolitých plochách.
